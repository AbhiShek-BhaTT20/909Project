...
public class EmployeeAPI {
	...
	public ResponseEntity<String> addRole(@Valid @RequestBody EmployeeDTO employeeDTO) throws EmployeeException{
	 ...
	 public ResponseEntity<String> updateemployee(@Valid @RequestBody EmployeeDTO employeeDTO,@PathVariable Integer id) throws EmployeeException{
